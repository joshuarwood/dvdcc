...
// Class for tracking the progress of loops by displaying
// percentage complete, elapsed time, and remaining time
class Progress {

 public:
  Progress(const char *s, bool only_elapsed = false) : only_elapsed(only_elapsed) {
